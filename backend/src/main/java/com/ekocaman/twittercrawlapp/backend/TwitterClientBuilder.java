...
public class TwitterClientBuilder {
    ...
    private static String loadVersion() {
        ...
        try {
            InputStream stream = TwitterClientBuilder.class.getClassLoader().getResourceAsStream("build.properties");
            try {
...
//                .build();
     ...
     */
    public TwitterClientBuilder name(String name) {
     ...
     */
    public TwitterClientBuilder gzipEnabled(boolean gzip) {
     ...
     */
    public TwitterClientBuilder hosts(String host) {
        this.hosts = new HttpHosts(Preconditions.checkNotNull(host));
        return this;
    }

    public TwitterClientBuilder hosts(Hosts hosts) {
     ...
     */
    public TwitterClientBuilder endpoint(StreamingEndpoint endpoint){
        this.endpoint = Preconditions.checkNotNull(endpoint);
        return this;
    }

    public TwitterClientBuilder authentication(Authentication auth) {
        this.auth = auth;
        return this;
    }

    public TwitterClientBuilder processor(HosebirdMessageProcessor processor) {
        this.processor = processor;
        return this;
    }

    public TwitterClientBuilder eventMessageQueue(BlockingQueue<Event> events) {
        this.eventQueue = events;
        return this;
    }

    public TwitterClientBuilder socketTimeout(int millis) {
        this.socketTimeoutMillis = millis;
        return this;
    }

    public TwitterClientBuilder connectionTimeout(int millis) {
     ...
     */
    public TwitterClientBuilder retries(int retries) {
        this.reconnectionManager = new BasicReconnectionManager(retries);
        return this;
    }

    public TwitterClientBuilder reconnectionManager(ReconnectionManager manager) {
        this.reconnectionManager = Preconditions.checkNotNull(manager);
        return this;
    }

    public TwitterClientBuilder endpoint(String uri, String httpMethod) {
        Preconditions.checkNotNull(uri);
        this.endpoint = new RawEndpoint(uri, httpMethod);
        return this;
    }

    public TwitterClientBuilder rateTracker(RateTracker rateTracker) {
        this.rateTracker = Preconditions.checkNotNull(rateTracker);
        return this;
    }

    public TwitterClientBuilder schemeRegistry(SchemeRegistry schemeRegistry) {
