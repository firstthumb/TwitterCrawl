 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.twittercrawlapp.ekocaman.com", ownerName = "backend.twittercrawlapp.ekocaman.com", packagePath = ""))
